                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      constraints:
                          const BoxConstraints(maxWidth: 250, maxHeight: 280),
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                          colors: [
                            AppColors.accentLimeBright,
                            AppColors.accentLimeBright
                          ],
                        ),
                        ...
                        Container(
                          ...
                          child: const Column(
                            children: [
                              ...
                              SizedBox(height: 16),
                              PaymentDetailRow(
                                  label: 'Date', value: '19/09/2025'),
                              SizedBox(height: 16),
                              PaymentDetailRow(
                                  label: 'Transaction ID',
                                  value: 'RCN0235628HUYJ'),
                            ],
                          ),
                        ),
                      ],
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: AppColors.accentLimeBright,
