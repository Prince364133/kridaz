...
import { X, Home, Users, Calendar, Video, LayoutDashboard, Target, Activity } from "lucide-react";
      ...
      >
        ...
        <div className="flex flex-col p-8 border-b border-white/5 bg-black/20 gap-4">
          ...
          <div className="flex flex-col">
            <span className="telemetry-label text-[10px] text-primary/80 mb-1">Sector 4-Coach</span>
            <span className="font-display-heavy text-xl text-white tracking-widest leading-none">STRATEGY_HUB</span>
          </div>
          
          <div className="flex items-center gap-2">
             <Activity size={10} className="text-primary animate-pulse" />
             <span className="telemetry-label text-[9px] text-white/30 uppercase tracking-[0.3em]">Live Intelligence</span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                 ...
                 <span className="telemetry-label text-[9px] text-primary">Tactical Link</span>
              </div>
              <div className="text-[11px] font-display-heavy text-white/60 tracking-widest leading-none">HEAD_COACH</div>
            </div>
          </div>
        </div>
      </aside>
