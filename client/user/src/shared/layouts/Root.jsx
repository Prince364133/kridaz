...
const Root = () => {
  ...
  const isBusinessVenue = location.pathname.startsWith('/business/venue');
  const isFullBleedPage = isNewPostPage || isTeamsPage || isBusinessVenue;
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-x-clip font-sans">
      ...
      <div className="flex flex-1 relative w-full">
        ...
        } ${showRightSidebar ? 'xl:pr-[440px]' : ''} transition-all duration-300 min-w-0 flex justify-center ${isFullBleedPage ? 'py-0' : 'py-6'}`}>
          
          <div className={`w-full ${isFullBleedPage ? 'max-w-none px-0' : useRestrictedWidth ? 'max-w-[495px]' : 'px-4 md:px-8 max-w-none'} flex flex-col justify-between`}>
