...
export default function EditProfileModal({ isOpen, onClose, user }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-[#0a0a0a] border border-white/10 rounded-[15px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        {/* Header - Compact */}
        <div className="px-6 py-4 border-b border-white/10 flex items-center justify-between bg-gradient-to-r from-[#55DEE8]/5 to-transparent">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[15px] bg-[#55DEE8]/10 flex items-center justify-center shrink-0">
          ...
          <button 
            onClick={onClose}
            className="p-2 rounded-[15px] hover:bg-white/5 text-white/40 hover:text-white transition-all border border-transparent hover:border-white/5"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[85vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            ...
            <div className="flex flex-col">
              ...
              <div className="relative group shrink-0 w-20 h-20">
                <div className="w-20 h-20 rounded-[15px] bg-gradient-to-br from-[#55DEE8]/10 to-[#BFF367]/10 border border-white/10 overflow-hidden flex items-center justify-center group-hover:border-[#55DEE8]/30 transition-all p-[1px]">
                  {user?.profilePicture ? (
                    <img 
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0d0d0d] border border-white/10 rounded-[15px] py-2.5 pl-10 pr-3 text-xs text-white focus:outline-none focus:border-[#55DEE8] focus:ring-4 focus:ring-[#55DEE8]/10 transition-all placeholder-white/20"
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between ml-1">
                  ...
                  {usernameStatus && (
                    <span className={`text-[9px] font-bold uppercase tracking-wider ${
                      usernameStatus === 'available' ? 'text-[#BFF367]' : 
                ...
                <div className="relative group">
                  <span className={`absolute left-3.5 top-1/2 -translate-y-1/2 font-black text-xs transition-colors ${
                    usernameStatus === 'available' ? 'text-[#BFF367]' : 
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full bg-[#0d0d0d] border rounded-[15px] py-2.5 pl-9 pr-10 text-xs text-white focus:outline-none focus:ring-4 transition-all placeholder-white/20 ${
                      usernameStatus === 'available' ? 'border-[#BFF367]/50 focus:border-[#BFF367] focus:ring-[#BFF367]/10' :
                      usernameStatus === 'taken' ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/10' :
                      'border-white/10 focus:border-[#55DEE8] focus:ring-[#55DEE8]/10'
                    }`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-[#0d0d0d] border border-white/10 rounded-[15px] py-2.5 pl-10 pr-10 text-xs text-white focus:outline-none focus:border-[#55DEE8] focus:ring-4 focus:ring-[#55DEE8]/10 transition-all appearance-none cursor-pointer"
                >
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <textarea
                ...
                value={formData.bio}
                onChange={handleChange}
                className="w-full bg-[#0d0d0d] border border-white/10 rounded-[15px] py-2.5 pl-10 pr-3 text-xs text-white focus:outline-none focus:border-[#55DEE8] focus:ring-4 focus:ring-[#55DEE8]/10 transition-all min-h-[60px] resize-none placeholder-white/20"
          ...
          <div className="space-y-1.5" ref={locationRef}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-[#0d0d0d] border border-white/10 rounded-[15px] py-2.5 pl-10 pr-10 text-xs text-white focus:outline-none focus:border-[#55DEE8] focus:ring-4 focus:ring-[#55DEE8]/10 transition-all placeholder-white/20"
              />
              {isSearchingLocation && (
                <div className="absolute right-3.5 top-1/2 -translate-y-1/2">
              ...
              {showSuggestions && locationSuggestions.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-[#0A0A0A] border border-white/10 rounded-[15px] overflow-hidden z-[110] shadow-2xl max-h-[140px] overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5 mb-1.5">
              {(formData.interests || []).map((interest, idx) => (
                <span key={idx} className="px-2.5 py-0.5 bg-[#55DEE8]/15 border border-[#55DEE8]/30 rounded-[15px] text-[9px] font-bold text-[#55DEE8] flex items-center gap-1.5">
                  {interest}
                  <button 
                    type="button"
                    onClick={() => {
          ...
          <div className="pt-4 flex items-center gap-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-6 py-2.5 rounded-[15px] border border-white/10 text-white/40 text-[9px] font-black uppercase tracking-widest hover:bg-white/5 hover:text-white transition-all"
            >
              Cancel
            </button>
            <button
