          ...
          {!isSuccess ? (
            ...
            >
              ...
              <div className="p-8 pb-4">
                <p className="text-[10px] font-bold text-[#BFF367] uppercase tracking-widest mb-1">Secure Checkout</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[30, 50, 100].map((pct) => (
                        ...
                        >
                          <span className={`text-sm font-black ${paymentPercentage === pct ? "text-[#BFF367]" : "text-white"}`}>
                            {pct}%
                          </span>
                          <span className={`text-[8px] font-bold uppercase tracking-tighter ${paymentPercentage === pct ? "text-[#BFF367]/60" : "text-zinc-500"}`}>
                    ...
                    <div className="flex items-center justify-between px-1">
                        ...
                        {paymentMode === "WALLET" && (
                            <div className="flex items-center gap-1.5 px-2 py-1 bg-[#BFF367]/10 rounded-[6px]">
                                <Zap size={10} className="text-[#BFF367] fill-[#BFF367]" />
                                <span className="text-[8px] font-black text-[#BFF367] uppercase">5% Cashback</span>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-[6px] ${paymentMode === "WALLET" ? "bg-[#BFF367] text-black" : "bg-[#000000] text-zinc-500"}`}>
                            <Wallet size={20} />
                          </div>
                        ...
                        {paymentMode === "WALLET" && <Check size={16} className="text-[#BFF367]" />}
                      </button>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-[6px] ${paymentMode === "UPI" ? "bg-[#BFF367] text-black" : "bg-[#000000] text-zinc-500"}`}>
                            <Smartphone size={20} />
                          </div>
                          <div className="text-left">
                        ...
                        {paymentMode === "UPI" && <Check size={16} className="text-[#BFF367]" />}
                      </button>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-[6px] ${paymentMode === "CARD" ? "bg-[#BFF367] text-black" : "bg-[#000000] text-zinc-500"}`}>
                            <CreditCard size={20} />
                          </div>
                          <div className="text-left">
                        ...
                        {paymentMode === "CARD" && <Check size={16} className="text-[#BFF367]" />}
                      </button>
              ...
              {paymentMode === "WALLET" && (
                <div className="bg-[#BFF367]/10 border border-[#BFF367]/20 rounded-[8px] p-5 mb-8 relative overflow-hidden group">
                  ...
                  <div className="flex items-center justify-center gap-4 relative z-10">
                    ...
                    <div className="text-left">
                        <p className="text-[10px] font-black text-[#BFF367] uppercase tracking-[0.2em]">Cashback Reward</p>
