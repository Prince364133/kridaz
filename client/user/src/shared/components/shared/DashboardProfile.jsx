      ...
      <div className="max-w-[1600px] mx-auto mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#2D2D2D] pb-10">
        ...
        <div className="flex items-center gap-4">
           <div className="flex items-center gap-2 px-4 py-2 bg-[#BFF367]/10 border border-[#BFF367]/20 rounded-[6px]">
             ...
             <span className="text-[10px] font-bold text-[#BFF367] uppercase tracking-widest">{roleLabel} Verified</span>
           </div>
           <button 
...
const ProfileDetailItem = ({ icon: Icon, label, value }) => (
  <div className="flex items-center justify-between group/item">
    <div className="flex items-center gap-3">
      <div className="p-2 bg-[#2D2D2D] rounded-[4px] text-[#999999] group-hover/item:text-[#BFF367] transition-colors"><Icon size={14} /></div>
...
const InfoField = ({ label, value, icon: Icon, prefix, disabled }) => (
  <div className="space-y-3">
    ...
    <div className="relative group/input">
      {Icon && <Icon className="absolute left-4 top-1/2 -translate-y-1/2 text-[#999999] group-focus-within/input:text-[#BFF367] transition-colors" size={18} />}
      {prefix && <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#999999] text-[13px] font-bold group-focus-within/input:text-[#BFF367] transition-colors">{prefix}</div>}
      <input 
        type="text" 
        defaultValue={value}
        disabled={disabled}
...
const QuickSettingAction = ({ icon: Icon, title, desc }) => (
  <div className="bg-[#000000] border border-[#2D2D2D] p-6 rounded-[8px] flex items-center gap-5 hover:border-[#BFF367]/20 transition-all cursor-pointer group shadow-[var(--shadow-2)]">
    ...
    <div>
      <h4 className="text-[14px] font-semibold text-white uppercase tracking-tight group-hover:text-[#BFF367] transition-colors">{title}</h4>
