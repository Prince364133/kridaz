        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6 text-center">
          <div className="max-w-md w-full space-y-8 bg-[#0A0A0A] border border-white/5 p-10 rounded-[8px]">
            <div className="space-y-4">
              <h1 className="text-6xl font-black text-[#55DEE8] uppercase tracking-tighter">FATAL ERROR</h1>
            ...
            <div className="pt-6">
              <button 
                ...
                className="inline-flex items-center gap-2 px-8 py-3 bg-[#55DEE8] text-black font-bold uppercase text-xs tracking-widest rounded-[8px] hover:scale-[0.98] transition-all"
              >
