        ...
        <div className="flex flex-col justify-center flex-grow max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 sm:gap-8">
            <Link
              ...
              className="inline-flex items-center justify-center gap-3 font-black text-black rounded-[6px] px-10 py-5 hover:brightness-110 hover:shadow-[0_0_20px_rgba(85,222,232,0.4)] transition-all bg-gradient-to-r from-[#BFF367] to-[#BFF367] uppercase tracking-widest text-xs md:text-sm"
            >
