      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mt-20 md:mt-32 max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 md:gap-8">
            {[
              { 
                text: "ΓÇ£Kridaz turned idle slots into steady revenue. The dashboard is a total gameΓÇæchanger for my business operations.ΓÇ¥", 
                name: "Priya Sharma", 
                role: "Arena 51 Owner", 
                icon: Trophy 
              },
              { 
                text: "ΓÇ£Automated bookings freed up my staffΓÇÖs time and boosted our evening bookings by 35%. Highly recommended.ΓÇ¥", 
                name: "Rajesh Kumar", 
