...
import { ArrowRight, Calendar, Star, Trophy, CheckCircle, Layout, ShieldCheck, X, User, Landmark, QrCode } from "lucide-react";
        ...
        <div className="mt-32 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              ...
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Expert Status</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Complete your profile and get verified to access professional scoring gigs.</p>
            </div>
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              <div className="flex items-center justify-center w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/10 group-hover:bg-[#55DEE8]/20 transition-colors">
                <Calendar className="w-7 h-7 text-white transition-colors" stroke="currentColor" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Accept Matches</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Review match invitations and accept those that match your availability.</p>
            </div>
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              <div className="flex items-center justify-center w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/10 group-hover:bg-[#55DEE8]/20 transition-colors">
                <CheckCircle className="w-7 h-7 text-white transition-colors" stroke="currentColor" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Power The Game</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Launch the scoring console to track the match ball-by-ball with precision.</p>
            </div>
          </div>
        </div>
