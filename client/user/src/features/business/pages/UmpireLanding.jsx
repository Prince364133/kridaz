...
import { ArrowRight, Calendar, Star, Trophy, CheckCircle, ShieldCheck, X, User, Landmark, QrCode, Upload, CheckCircle2, AlertCircle, Clock } from "lucide-react";
...
const PENDING_KEY = "umpire_application_pending";
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mt-32 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { icon: ShieldCheck, title: "Get Verified",      desc: "Upload your certifications and background checks to join the elite pool." },
              { icon: Calendar,    title: "Set Availability",  desc: "Mark your free weekends and preferred match locations on the map." },
              { icon: CheckCircle, title: "Get Paid Fast",     desc: "Instant payouts after match completion through our secure payment gateway." },
            ].map((s, i) => (
