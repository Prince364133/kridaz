...
import { ArrowRight, Calendar, Star, Trophy, CheckCircle, ShieldCheck, X, User, Landmark, QrCode } from "lucide-react";
...
export default function UmpireLanding() {
  ...
  return (
    <div className="relative min-h-screen text-white pt-4 pb-20 overflow-hidden" style={{ backgroundColor: "#000" }}>
      ...
      {/* ΓöÇΓöÇ Gradient Definition for Icons ΓöÇΓöÇ */}
      ...
      <div className="absolute -top-20 right-0 w-[600px] h-[400px] rounded-full pointer-events-none"
        style={{ background: `radial-gradient(circle, rgba(85,222,232,0.10) 0%, transparent 70%)` }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center min-h-[80vh]">
          <div>
            ...
            >
              <span style={{ background: GRADIENT, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontFamily: "'Inter'" }}>Certified Officials</span>
            </div>
            <h1 className="text-[48px] md:text-[72px] leading-[1.1] uppercase mb-6 font-bold text-white" style={{ fontFamily: "'Open Sans'" }}>
              Officiate & <br /><span style={{ background: GRADIENT, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Earn.</span>
            </h1>
        ...
        <div className="mt-32 text-center">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-10 md:mb-12 uppercase tracking-tight" style={{ fontFamily: "'Open Sans'" }}>The Road to Pro Officiating</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              <div className="flex items-center justify-center w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/10 group-hover:bg-[#55DEE8]/20 transition-colors">
                <ShieldCheck className="w-7 h-7 text-white transition-colors" stroke="currentColor" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Get Verified</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Upload your certifications and background checks to join the elite pool.</p>
            </div>
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              <div className="flex items-center justify-center w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/10 group-hover:bg-[#55DEE8]/20 transition-colors">
                <Calendar className="w-7 h-7 text-white transition-colors" stroke="currentColor" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Set Availability</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Mark your free weekends and preferred match locations on the map.</p>
            </div>
            <div className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-[#55DEE8]/30 transition-colors group">
              <div className="flex items-center justify-center w-14 h-14 mx-auto mb-6 rounded-2xl bg-white/10 group-hover:bg-[#55DEE8]/20 transition-colors">
                <CheckCircle className="w-7 h-7 text-white transition-colors" stroke="currentColor" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 uppercase tracking-wider" style={{ fontFamily: "'Open Sans'" }}>Get Paid Fast</h3>
              <p className="text-gray-400 text-sm md:text-base leading-relaxed" style={{ fontFamily: "'Inter'" }}>Instant payouts after match completion through our secure payment gateway.</p>
            </div>
          </div>
        </div>
      ...
      {/* ΓöÇΓöÇ Registration Modal ΓöÇΓöÇ */}
      {isModalOpen && (
