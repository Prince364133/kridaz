...
const GameDetailsModal = ({ game, onClose, onJoinSlot, currentUserId }) => {
  ...
  const renderSlotStatus = (slot, teamKey, index) => {
    ...
    return (
      <button 
        ...
        className="w-full flex items-center justify-between p-3 rounded-xl bg-slate-800/40 border border-white/5 text-slate-400 hover:text-violet-400 hover:border-violet-500/40 hover:bg-violet-500/5 transition-all text-left group/slot"
      >
        <div className="flex items-center gap-2">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl border border-white/10 bg-slate-900 shadow-2xl overflow-hidden">
        {/* Header decoration */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 rounded-2xl bg-slate-850/50 border border-white/5 text-sm text-slate-300">
          ...
          <div className="space-y-3 pt-4 border-t border-white/5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-3 rounded-xl bg-slate-800/40 border border-white/5 text-xs">
