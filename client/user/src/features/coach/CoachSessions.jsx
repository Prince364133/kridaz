        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10 pb-2 border-b border-white/5">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-4 bg-white/[0.03] border border-white/5 px-6 py-4 rounded-[8px] backdrop-blur-xl">
              <div className="w-12 h-12 bg-[#BFF367]/10 rounded-[8px] flex items-center justify-center text-[#BFF367]">
                <Calendar size={24} />
              </div>
              <div className="space-y-0.5">
                ...
                <p className="text-[#BFF367] text-[10px] font-semibold uppercase tracking-widest opacity-80">
            ...
            <button className="px-6 py-4 bg-[#BFF367] hover:bg-[#BFF367]/90 text-black rounded-[8px] font-bold uppercase text-[11px] tracking-widest flex items-center gap-2 hover:scale-[0.98] transition-all font-inter shadow-2xl active:scale-95">
      ...
      {sessions.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {sessions.map((session) => (
            <div key={session._id} className="group relative bg-[#000000] border border-[#2D2D2D] rounded-[8px] p-6 hover:border-[#BFF367]/30 transition-all duration-500 shadow-[var(--shadow-2)]">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex gap-6 flex-1">
                  ...
                  <div className="space-y-3">
                    ...
                    <h3 className="text-lg font-bold text-white group-hover:text-[#BFF367] transition-colors font-inter tracking-tight">{session.name}</h3>
                    ...
                    <div className="flex flex-wrap gap-6 text-[13px] text-[#878C9F] font-inter">
                      ...
                      <div className="flex items-center gap-2">
                        <Video size={14} className="text-[#BFF367]" />
                ...
                <div className="w-full md:w-auto flex flex-col items-stretch gap-3">
                  <button className="px-6 py-2.5 bg-transparent hover:bg-[#BFF367]/10 text-[#999999] hover:text-[#BFF367] text-xs font-bold uppercase tracking-widest rounded-[6px] border border-[#2D2D2D] hover:border-[#BFF367]/30 transition-all flex items-center justify-center gap-2 font-inter">
