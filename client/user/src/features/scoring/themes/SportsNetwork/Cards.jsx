...
const SportsNetworkEndOfOverCard = ({ score }) => (
  <div style={{ padding: '20px', width: '350px', background: '#ffffff', border: '4px solid #dc2626', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkMilestoneCard = ({ data }) => (
  <div style={{ padding: '20px', width: '300px', textAlign: 'center', background: '#ffffff', border: '4px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkPartnershipCard = ({ data }) => (
  <div style={{ padding: '20px', width: '350px', background: '#ffffff', border: '4px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkNewBatterCard = ({ data }) => (
  <div style={{ padding: '20px', width: '300px', background: '#ffffff', border: '4px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkBowlerChangeCard = ({ data }) => (
  <div style={{ padding: '20px', width: '300px', background: '#ffffff', border: '4px solid #dc2626', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkInningsBreakCard = ({ data }) => (
  <div style={{ padding: '30px', width: '400px', textAlign: 'center', background: '#ffffff', border: '6px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkMatchResultCard = ({ data }) => (
  <div style={{ padding: '40px', width: '500px', textAlign: 'center', background: '#ffffff', border: '6px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkTimeoutCard = ({ data }) => (
  <div style={{ padding: '20px', width: '300px', textAlign: 'center', background: '#ffffff', border: '4px solid #dc2626', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
...
const SportsNetworkWormCard = ({ data }) => (
  <div style={{ padding: '20px', width: '400px', background: '#ffffff', border: '4px solid #1e3a8a', borderRadius: '8px', color: '#000', fontFamily: "'Open Sans', sans-serif" }}>
