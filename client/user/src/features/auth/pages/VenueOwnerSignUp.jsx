                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                      ...
                      <div className="space-y-3 group/field">
                        ...
                        <div className="relative">
                          ...
                          <input {...register("password")} type="password" placeholder="G��G��G��G��G��G��G��G��" className="w-full bg-white/[0.03] border border-white/5 focus:border-[#55DEE8]/50 rounded-xl h-14 pl-12 pr-4 text-white text-sm placeholder:text-white/10 outline-none transition-all" />
                        </div>
                      ...
                      <div className="space-y-3 group/field">
                        ...
                        <div className="relative">
                          ...
                          <input {...register("confirmPassword")} type="password" placeholder="G��G��G��G��G��G��G��G��" className="w-full bg-white/[0.03] border border-white/5 focus:border-[#55DEE8]/50 rounded-xl h-14 pl-12 pr-4 text-white text-sm placeholder:text-white/10 outline-none transition-all" />
                        </div>
