...
export default function PartnersGateway() {
  return (
    <div className="min-h-screen bg-[#000] text-white selection:bg-[#BFF367] selection:text-black font-sans pt-16 lg:pt-20">
        ...
        <div className="container mx-auto px-6 lg:px-20 relative z-10">
          <div className="max-w-4xl space-y-10">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-[6px] border border-white/10 bg-white/5">
              <Globe className="w-4 h-4 text-[#BFF367]" />
            ...
            <div className="space-y-6">
              <h1 className="text-6xl lg:text-[7rem] font-bold leading-[0.9] tracking-tight uppercase">
                JOIN US AS A <br />
                <span className="text-[#BFF367]">PARTNER.</span>
              </h1>
              <p className="text-lg text-white/40 max-w-2xl border-l-2 border-[#BFF367] pl-8 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Link to="/signup/venue" className="bg-[#BFF367] hover:bg-[#a3e635] text-black h-14 px-8 rounded-[8px] font-bold text-sm flex items-center gap-3 transition-all shadow-[0_10px_30px_rgba(85,222,232,0.2)] active:scale-[0.98]">
              ...
              <div className="hidden sm:flex items-center gap-10 border-l border-white/10 pl-10">
                <div className="space-y-1">
                  ...
                  <p className="text-2xl font-bold text-[#BFF367]">1,200+</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest">Growth Rate</p>
                  <p className="text-2xl font-bold text-[#BFF367]">85% YoY</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ΓöÇΓöÇ PARTNER ROLES GRID ΓöÇΓöÇ */}
      <section className="relative z-10 py-16 container mx-auto px-6">
        ...
        <div className="mt-40 p-20 bg-gradient-to-b from-[#0A0A0A] to-black border border-white/5 rounded-[8px] text-center relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-[#BFF367]/20 to-transparent" />
