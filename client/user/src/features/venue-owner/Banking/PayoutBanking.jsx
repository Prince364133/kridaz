...
/**
 * PayoutBanking — Secure banking, KYC, and settlement management.
                                  ...
                                  <td className="px-8 py-6">
                                     <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                           ...
                                           <p className="text-[9px] text-neutral-500 font-bold uppercase tracking-widest mt-1">{tx.type} • {tx.status}</p>
                                        </div>
                                     </div>
                                  </td>
