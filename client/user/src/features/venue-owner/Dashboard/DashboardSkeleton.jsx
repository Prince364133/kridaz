  ...
  return (
    <div className="h-full bg-[#000000] px-1 lg:px-3 lg:pt-2 space-y-10 animate-pulse">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-5">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-[#121212] border border-white/5 rounded-[8px] p-5 h-[140px] flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-6 h-[400px] bg-[#121212] border border-white/5 rounded-[8px] p-8 space-y-6">
          ...
          <div className="flex-1 h-full bg-[#111111]/50 rounded-[8px] border border-white/5/30"></div>
        </div>
        
        <div className="lg:col-span-3 h-[400px] bg-[#121212] border border-white/5 rounded-[8px] p-8 space-y-6">
          <div className="space-y-2">
            <div className="w-32 h-6 bg-[#2D2D2D] rounded"></div>
            <div className="w-24 h-3 bg-[#2D2D2D] rounded opacity-50"></div>
          </div>
          <div className="flex flex-col items-center gap-8">
            <div className="w-32 h-32 rounded-full border-[10px] border-white/5"></div>
        ...
        <div className="lg:col-span-3 h-[400px] bg-[#121212] border border-white/5 rounded-[8px] p-8 space-y-6">
          ...
          <div className="flex flex-col items-center justify-center pt-4">
             <div className="w-28 h-28 rounded-full border-[8px] border-white/5"></div>
          </div>
      ...
      {/* Heatmap Skeleton */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         <div className="lg:col-span-8 h-[300px] bg-[#121212] border border-white/5 rounded-[8px] p-8 space-y-4">
            <div className="w-48 h-6 bg-[#2D2D2D] rounded"></div>
            <div className="w-full h-40 bg-[#111111]/50 rounded border border-white/5/30"></div>
         </div>
         <div className="lg:col-span-4 h-[300px] bg-[#121212] border border-white/5 rounded-[8px] p-8 space-y-4">
            <div className="w-32 h-6 bg-[#2D2D2D] rounded"></div>
