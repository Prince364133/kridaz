  ...
  return (
    <div className="h-full bg-[#000000] px-1 lg:px-3 lg:pt-2 space-y-10 animate-pulse">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-5">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-[#121212] border border-white/10 rounded-[16px] p-5 h-[140px] flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3 h-[400px] bg-[#121212] border border-white/10 rounded-[16px] p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-10 bg-[#1B1B1B]/50 rounded-[16px]"></div>
            ))}
          </div>
        </div>
      </div>
