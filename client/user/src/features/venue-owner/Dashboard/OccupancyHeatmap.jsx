        ...
        <div className="min-w-[700px] space-y-2">
          ...
          {days.map((day, dIdx) => (
            <div key={day} className="flex items-center gap-1">
              <div className="w-10 text-[10px] font-medium text-white/70 uppercase tracking-wider">{day}</div>
            ...
            <div className="max-h-[60vh] overflow-y-auto p-6 space-y-4 no-scrollbar">
              {selectedSlot.details.length > 0 ? (
                selectedSlot.details.map((b, idx) => (
                  <div key={idx} className="bg-[#121212] p-5 rounded-[16px] border border-white/10 hover:border-[#55DEE8]/50 transition-all group">
