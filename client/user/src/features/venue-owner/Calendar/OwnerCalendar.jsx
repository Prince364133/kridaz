    ...
    <div className="h-full custom-scrollbar bg-[#0D0D0D] text-white font-inter">
      <div className="p-6 lg:px-10 lg:pt-10 space-y-10 pb-32">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
           <div className="flex items-center gap-12">
              ...
              <div className="flex items-center gap-2">
                 ...
                 <button onClick={handleToday} className="ml-4 px-6 py-2 bg-[#1A1A1A] border border-[#2D2D2D] rounded-[8px] text-[12px] font-black uppercase tracking-[3px] hover:text-[#BFF367] transition-all">
                    Today
                 </button>
              </div>
           </div>
                      ...
                      return (
                        <div key={time} className="min-w-[150px] border-r border-[#2D2D2D]/30 flex items-center justify-center p-4">
                           {isBooked ? (
                             ...
                             <div className="w-full h-full rounded-[12px] border border-dashed border-[#2D2D2D]/50 flex items-center justify-center group cursor-pointer hover:border-[#BFF367]/30 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             { label: 'Confirmed Slots', value: data?.stats?.confirmedSlots || 0, trend: '+12%', icon: Activity, color: '#BFF367' },
             ...
             <div key={i} className="bg-[#111] border border-[#2D2D2D] p-8 rounded-[12px] flex flex-col justify-between relative overflow-hidden group hover:border-[#BFF367]/30 transition-all">
