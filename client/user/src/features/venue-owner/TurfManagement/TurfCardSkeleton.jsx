const TurfCardSkeleton = () => {
  return (
    <div className="bg-[#121212] border border-white/5 rounded-[8px] overflow-hidden animate-pulse h-full flex flex-col">
      ...
      <div className="p-2 md:p-3 space-y-3 flex-grow">
        ...
        <div className="mt-auto flex justify-between items-center">
           ...
           <div className="flex gap-1.5">
              <div className="w-6 h-6 md:w-7 md:h-7 bg-[#111] rounded-[6px]"></div>
              <div className="w-6 h-6 md:w-7 md:h-7 bg-[#111] rounded-[6px]"></div>
              <div className="w-6 h-6 md:w-7 md:h-7 bg-[#111] rounded-[6px]"></div>
           </div>
        </div>
