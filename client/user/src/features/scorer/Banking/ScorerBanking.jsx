...
/**
 * ScorerBanking Rs � Secure banking, KYC, and settlement management.
...
const ScorerBanking = () => {
  ...
  const { dashboardData, loading: dashboardLoading } = useScorerDashboard();
