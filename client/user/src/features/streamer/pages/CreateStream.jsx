...
const CreateStream = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {[1, 2, 3].map(num => (
          <div 
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-4 transition-all duration-300 ${
              step >= num 
                ? "bg-[#55DEE8] border-black text-black" 
      ...
      {step === 1 && (
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl animate-in fade-in duration-300">
          ...
          <form onSubmit={handleFetchMatch} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#55DEE8] transition-colors"
                  required
                />
              </div>
            ...
            <button
              type="submit"
              className="bg-[#55DEE8] hover:bg-[#55DEE8]/90 text-black font-bold py-4 px-8 rounded-xl w-full sm:w-auto transition-colors flex items-center justify-center gap-2"
            >
              Fetch Match Data
            </button>
          </form>
      ...
      {step === 2 && (
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl animate-in fade-in duration-300">
          ...
          <div className="mb-8 p-4 bg-black/50 border border-white/10 rounded-xl">
          ...
          <div className="flex gap-4">
            <button
              onClick={() => setStep(1)}
              className="px-8 py-4 rounded-xl font-bold text-white bg-white/10 hover:bg-white/20 transition-colors"
            >
              Back
            </button>
            <button
              ...
              className="px-8 py-4 rounded-xl font-bold text-black bg-[#55DEE8] hover:bg-[#55DEE8]/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-1 sm:flex-none"
            >
              Generate Ticker
            </button>
          </div>
        ...
        <div className="bg-white/5 border border-white/10 p-8 rounded-2xl animate-in fade-in duration-300">
          ...
          <div className="space-y-6">
            <div className="bg-black/50 border border-white/10 p-6 rounded-xl">
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-black border border-white/20 rounded-lg p-3 font-mono text-sm text-gray-300 overflow-x-auto whitespace-nowrap">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              ...
              className="px-8 py-4 rounded-xl font-bold text-black bg-[#55DEE8] hover:bg-[#55DEE8]/90 transition-colors flex-1 sm:flex-none text-center"
            >
