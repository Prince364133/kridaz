  ...
  return (
    <div className="min-h-screen bg-black text-white pt-24 pb-12 font-sans selection:bg-[#BFF367]/30">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-4xl font-black mb-8 uppercase tracking-tight text-[#BFF367]">Data Deletion Instructions</h1>
        ...
        <div className="space-y-8 text-white/70 leading-relaxed text-sm md:text-base">
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>Logging in to your account, navigating to the <Link to="/profile" className="text-[#BFF367] hover:underline">Profile Settings</Link> section, and selecting "Delete Account".</li>
              <li>Or, sending an email to <a href="mailto:privacy@kridaz.com" className="text-[#BFF367] hover:underline">privacy@kridaz.com</a> with the subject line "Data Deletion Request".</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>If you need assistance with the data deletion process, please contact us at <a href="mailto:privacy@kridaz.com" className="text-[#BFF367] hover:underline">privacy@kridaz.com</a>.</p>
          </section>
        </div>
