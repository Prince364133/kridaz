  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pt-24 pb-12 font-sans selection:bg-[#55DEE8]/30">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-4xl font-black mb-8 uppercase tracking-tight text-[#55DEE8]">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-white/70 leading-relaxed text-sm md:text-base">
          ...
          <section>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:contact@kridaz.com" className="text-[#55DEE8] hover:underline">contact@kridaz.com</a>.</p>
          </section>
        </div>
