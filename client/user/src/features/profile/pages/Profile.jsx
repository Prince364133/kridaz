...
const AchievementCard = ({ icon: Icon, title, rarity, year }) => {
  ...
  const rarityGlow = {
    ...
    gold: 'shadow-[0_0_30px_rgba(85,222,232,0.4)]',
      ...
      <div className="relative">
        <div className={`w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-br ${rarityColors[rarity]} p-[2px]`}>
          <div className="w-full h-full bg-black rounded-full flex items-center justify-center">
            <Icon className="w-6 h-6 text-[#55DEE8]" />
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative -mt-16 z-10">
          <div className="flex flex-col md:flex-row items-end gap-6">
            <div className="relative group shrink-0">
              <div 
                className="w-32 h-32 md:w-40 md:h-40 rounded-full border-[4px] border-black bg-gradient-to-br from-[#55DEE8]/20 to-transparent p-1 shadow-[0_0_30px_rgba(85,222,232,0.3)] overflow-hidden cursor-pointer"
                onClick={handleAvatarClick}
              >
                {profileUser?.profilePicture ? (
                  <img src={profileUser.profilePicture} alt="" className="w-full h-full rounded-full object-cover" />
                ) : (
                  <div className="w-full h-full rounded-full flex items-center justify-center bg-zinc-900 text-[#55DEE8] text-4xl font-black">
                    {profileUser?.name?.[0]}
                  </div>
                )}
              </div>
              ...
              {isOwnProfile && (
                <button 
                  ...
                  className="absolute bottom-1 right-1 w-9 h-9 bg-[#55DEE8] rounded-full border-[4px] border-black flex items-center justify-center text-black hover:scale-110 transition-all shadow-lg z-20"
                >
            ...
            <div className="pb-2 flex-1 space-y-3">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <CheckCircle2 className="w-6 h-6 text-[#55DEE8]" fill="currentColor" />
                </div>
                <p className="text-lg font-bold text-gray-400 uppercase tracking-tight" style={SUBHEADING_STYLE}>
                  {profileUser?.role || "Athlete"} GÇó {profileUser?.interests?.[0] || "Sports"}
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-gray-400 font-bold uppercase tracking-widest text-[10px] md:text-xs">
                ...
                <span className="w-1 h-1 bg-zinc-700 rounded-full" />
                <span className="flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5 text-[#55DEE8]" />
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
                ...
                <div key={idx} className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden hover:border-[#55DEE8]/30 transition-all group">
                  ...
                  <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <img src={profileUser?.profilePicture} className="w-5 h-5 rounded-full border border-[#55DEE8]/30" />
        ...
        {activeTab === 'stories' && (
          <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-black text-white flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <Camera className="w-5 h-5 text-[#55DEE8]" />
                Recent Stories
              </h2>
            </div>
              ...
              {[
                ...
                <div key={idx} className="aspect-[9/16] relative rounded-2xl overflow-hidden border border-white/10 group cursor-pointer hover:border-[#55DEE8]/50 transition-all">
                  ...
                  <div className="absolute bottom-3 left-3">
                    ...
                    <p className="text-[8px] font-bold text-[#55DEE8] uppercase tracking-widest">{story.time}</p>
                  </div>
                </div>
              ))}
              {isOwnProfile && (
        ...
        {activeTab === 'activity' && (
          <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
            <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
              <Activity className="w-5 h-5 text-[#55DEE8]" />
        ...
        {activeTab === 'bookings' && (
          <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-black text-white flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <Calendar className="w-5 h-5 text-[#55DEE8]" />
                Your Bookings
              </h2>
            </div>
            ...
            <div className="space-y-4">
              {bookings && bookings.length > 0 ? (
                ...
                <>
                  {[
                    { name: 'Elite Football Arena', date: '24 May 2024', time: '18:00 - 19:30', price: 'Gé¦1,200', status: 'Confirmed', sport: 'Football', img: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=2070' },
                    { name: 'Thunder Cricket Ground', date: '20 May 2024', time: '09:00 - 12:00', price: 'Gé¦2,500', status: 'Completed', sport: 'Cricket', img: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=2070' },
                  ].map((mock, idx) => (
                    <div key={idx} className="bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-2xl p-4 flex flex-col md:flex-row gap-6 hover:border-[#55DEE8]/30 transition-all group overflow-hidden">
                      ...
                      <div className="flex-1 flex flex-col justify-between py-1">
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-[9px] font-black text-gray-500 uppercase tracking-widest">
                            <div className="flex items-center gap-1.5"><Clock size={12} className="text-[#55DEE8]" /> {mock.time}</div>
                            <div className="flex items-center gap-1.5"><Calendar size={12} className="text-[#55DEE8]" /> {mock.date}</div>
                            <div className="flex items-center gap-1.5"><MapPin size={12} className="text-[#55DEE8]" /> Manchester</div>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-col justify-between items-end py-1 shrink-0 border-t md:border-t-0 md:border-l border-white/5 pt-4 md:pt-0 md:pl-6">
                        ...
                        <div className={`px-3 py-1 rounded text-[8px] font-black uppercase tracking-widest border ${mock.status === 'Confirmed' ? 'text-[#55DEE8] bg-[#55DEE8]/10 border-[#55DEE8]/20' : 'text-gray-400 bg-white/5 border-white/10'}`}>
                          {mock.status}
                        </div>
                      </div>
                    </div>
          ...
          <>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              <div className="lg:col-span-2 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                  <User className="w-5 h-5 text-[#55DEE8]" />
                  Personal Details
                </h2>
            ...
            <div className="space-y-6 mb-8">
              <h2 className="text-xl font-black text-white flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <TrendingUp className="w-5 h-5 text-[#55DEE8]" />
                ...
                <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <RadarChart data={[
                      ...
                      <Radar name="Performance" dataKey="value" stroke="#55DEE8" fill="#55DEE8" fillOpacity={0.3} />
                    </RadarChart>
                  </ResponsiveContainer>
                </div>
                <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <LineChart data={[
                      ...
                      <Line type="monotone" dataKey="perf" stroke="#55DEE8" strokeWidth={3} dot={{ fill: '#55DEE8', r: 4, strokeWidth: 2, stroke: '#000' }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10 mb-8">
              <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <Award className="w-5 h-5 text-[#55DEE8]" />
                Certificates
              </h2>
                ...
                {[
                  ...
                  <div key={idx} className="group bg-black/40 rounded-xl overflow-hidden border border-white/10 hover:border-[#55DEE8]/30 transition-all">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-[9px] text-[#55DEE8] font-bold uppercase tracking-widest">{cert.date}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10 mb-8">
              <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <Trophy className="w-5 h-5 text-[#55DEE8]" />
                Achievements
              </h2>
            ...
            <div className="space-y-6 mb-8">
              <h2 className="text-xl font-black text-white flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                <BarChart3 className="w-5 h-5 text-[#55DEE8]" />
                Career Summary
              </h2>
              ...
              <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10 mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                  {[
                    { icon: Calendar, label: 'Years Active', value: '12', color: '#55DEE8' },
                    { icon: Target, label: 'Total Matches', value: '287', color: '#55DEE8' },
                    { icon: Building2, label: 'Total Clubs', value: '4', color: '#55DEE8' },
                    { icon: Zap, label: 'Total Goals', value: '145', color: '#55DEE8' },
                    { icon: Users, label: 'Assists', value: '89', color: '#55DEE8' },
                    { icon: Award, label: 'Tournaments', value: '18', color: '#55DEE8' },
                    { icon: Medal, label: 'MOTM Awards', value: '34', color: '#55DEE8' },
                    { icon: AlertTriangle, label: 'Red Cards', value: '2', color: '#ff4444' },
                    { icon: AlertTriangle, label: 'Yellow Cards', value: '23', color: '#ffaa00' },
                    { icon: BarChart3, label: 'Win Ratio', value: '69%', color: '#55DEE8' },
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  <h3 className="text-xs font-black text-white mb-4 flex items-center gap-2 uppercase tracking-widest" style={HEADING_STYLE}>
                    <Building2 className="w-4 h-4 text-[#55DEE8]" />
                    Previous Clubs
                  </h3>
                  <div className="space-y-2">
                    {[
                      { name: 'Manchester United', years: '2022-Present', logo: '=ƒö¦' },
                      { name: 'Chelsea FC', years: '2019-2022', logo: '=ƒö¦' },
                      { name: 'Liverpool FC', years: '2016-2019', logo: '=ƒö¦' },
                      { name: 'Arsenal Youth', years: '2012-2016', logo: '=ƒö¦' },
                    ].map((club, idx) => (
                ...
                <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  <h3 className="text-xs font-black text-white mb-4 flex items-center gap-2 uppercase tracking-widest" style={HEADING_STYLE}>
                    <Clock className="w-4 h-4 text-[#55DEE8]" />
                    Career Milestones
                  </h3>
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={idx} className="flex items-center gap-3 p-3 rounded-xl bg-black/40 border border-white/5">
                        <div className="w-10 h-10 rounded-lg bg-[#55DEE8]/10 flex items-center justify-center flex-shrink-0 border border-[#55DEE8]/20">
                          <span className="text-[#55DEE8] font-black text-[10px]">{m.year}</span>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-black/40 rounded-xl p-6 border border-white/5">
                  <div className="flex items-center justify-between mb-6">
                    <div className="text-center space-y-1">
                      <div className="w-16 h-16 rounded-full bg-red-500/20 flex items-center justify-center text-3xl border border-red-500/30">=ƒö¦</div>
                      <p className="text-[9px] font-black text-white uppercase">Man Utd</p>
                    </div>
                    <div className="text-center">
                      <p className="text-3xl font-black text-[#55DEE8] tracking-tighter mb-0.5 italic">VS</p>
                      <p className="text-[8px] font-black text-gray-500 uppercase tracking-widest">Premier League</p>
                    </div>
                    <div className="text-center space-y-1">
                      <div className="w-16 h-16 rounded-full bg-blue-500/20 flex items-center justify-center text-3xl border border-blue-500/30">=ƒö¦</div>
                      <p className="text-[9px] font-black text-white uppercase">Chelsea</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-4 gap-2 mb-6">
                    {Object.entries(timeLeft).map(([unit, val]) => (
                      <div key={unit} className="bg-[#55DEE8]/10 rounded-lg p-3 text-center border border-[#55DEE8]/20">
              ...
              <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                <h2 className="text-xl font-black text-white mb-6 flex items-center gap-2 uppercase tracking-tight" style={HEADING_STYLE}>
                  <UserPlus className="w-5 h-5 text-[#55DEE8]" />
                  Invite Players
                </h2>
                <div className="space-y-3">
                  {[
