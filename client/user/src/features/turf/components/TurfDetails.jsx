          ...
          <div className="w-[813px] flex-none space-y-8">
            ...
            <div className="flex items-center justify-between text-[12px] font-bold uppercase tracking-widest px-2 font-inter w-full">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <span className="text-zinc-400 font-medium">{turf.openingTime || "01:10 AM"} ΓÇö {turf.closingTime || "11:00 PM"}</span>
              </div>
              <div className="w-px h-3 bg-zinc-800" />
              <div 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-baseline gap-2">
                      <span className="bg-gradient-to-r from-[#55DEE8] to-[#BFF367] inline-block text-transparent bg-clip-text text-3xl font-inter font-bold">Γé╣{turf.pricePerHour}</span>
            ...
            >
              ...
              <div className="mt-auto pt-4 border-t border-zinc-800/80 flex items-center justify-between gap-4 shrink-0">
                <div className="space-y-0">
                  ...
                  <p className="text-2xl font-bold text-white leading-none">Γé╣{totalPrice || turf.pricePerHour}</p>
                </div>
                <button 
