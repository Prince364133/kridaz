...
const CheckoutPage = () => {
 ...
 // No useReservation here GÇö all booking data comes from location.state
 ...
 <p className="text-xl font-black text-[#55DEE8]">Gé¦{amountToPay}</p>
 </div>
 <div className="bg-black/20 p-4 rounded-2xl border border-zinc-800/50 flex flex-col items-center text-center">
 <p className="text-[9px] font-black text-zinc-500 uppercase tracking-widest mb-1">Pay at Venue</p>
 <p className="text-xl font-black text-orange-500">Gé¦{balanceAtVenue}</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-[10px] font-bold text-zinc-500 mt-0.5 uppercase tracking-widest">Available Balance: Gé¦{currentBalance}</p>
 </div>
 </div>
 ...
 Your wallet balance is insufficient for this booking. Required: Gé¦{amountToPay}
 </p>
 </div>
 <button
 ...
 <>
 Authorize Payment Gé¦{amountToPay}
 <ArrowRight size={24} />
 </>
 )}
 </button>
 ...
 End-to-end Encrypted GÇó PCI DSS Compliant
 </p>
 </div>
 </div>
 </div>
