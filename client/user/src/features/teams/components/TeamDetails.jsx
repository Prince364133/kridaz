        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {pendingRequests.map((req) => (
                    <div key={req._id} className="bg-orange-500/5 border border-orange-500/20 p-4 rounded-2xl flex items-center gap-4">
                      ...
                      <div className="flex gap-2">
                        <button 
                          ...
                          className="w-8 h-8 bg-orange-500 text-black rounded-lg flex items-center justify-center hover:bg-orange-400 transition-colors"
                        >
                          <Check size={12} />
                        </button>
                        <button 
                          ...
                          className="w-8 h-8 bg-white/5 text-white/40 rounded-lg flex items-center justify-center hover:bg-white/10 transition-colors"
                        >
                          <X size={12} />
                        </button>
                      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {customMembers.map((member, index) => (
                  <div key={index} className="bg-white/[0.02] p-4 rounded-2xl border border-white/5 border-l-4 border-l-yellow-500/50 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-yellow-500/10 flex items-center justify-center text-yellow-500">
                      <span className="text-lg font-black uppercase">{member.name.charAt(0)}</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <h4 className="text-white font-black text-sm truncate uppercase">{member.name}</h4>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {opponents.map((opp) => (
                <div key={opp._id} className="bg-white/[0.02] p-4 rounded-2xl border border-white/5 flex items-center gap-4 hover:bg-white/[0.04] transition-all cursor-pointer group">
                  <div className="w-10 h-10 rounded-lg bg-black border border-white/10 flex items-center justify-center text-red-500 overflow-hidden shrink-0">
              ...
              {opponents.length === 0 && (
                <div className="py-12 border border-dashed border-white/5 rounded-3xl flex flex-col items-center justify-center text-center p-6">
