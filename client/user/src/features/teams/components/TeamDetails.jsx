        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {pendingRequests.map((req) => (
                    <div key={req._id} className="bg-orange-500/5 border border-orange-500/20 p-4 rounded-[8px] flex items-center gap-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {customMembers.map((member, index) => (
                  <div key={index} className="bg-white/[0.02] p-4 rounded-[8px] border border-white/5 border-l-4 border-l-yellow-500/50 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-[8px] bg-yellow-500/10 flex items-center justify-center text-yellow-500">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {opponents.map((opp) => (
                <div key={opp._id} className="bg-white/[0.02] p-4 rounded-[8px] border border-white/5 flex items-center gap-4 hover:bg-white/[0.04] transition-all cursor-pointer group">
