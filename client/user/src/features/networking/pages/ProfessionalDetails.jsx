              ...
              <div className="bg-[#55DEE8] rounded-[40px] p-8 text-black mb-6 shadow-2xl shadow-[#55DEE8]/20">
                <div className="flex justify-between items-end mb-6">
                  <div>
                    ...
                    <p className="text-4xl font-display uppercase leading-none">Γé╣{pro.price || "500"}</p>
                  </div>
                ...
                <div className="pt-6 border-t border-neutral-800">
                  <div className="flex justify-between items-end mb-6">
                    <div>
                      ...
                      <p className="text-2xl font-display text-white">Γé╣{selectedSlots.length * (pro.price || 0)}</p>
                    </div>
