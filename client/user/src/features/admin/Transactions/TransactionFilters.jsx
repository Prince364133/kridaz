...
const inputCls =
  "h-9 bg-white/5 border border-white/10 rounded-xl text-xs text-white placeholder-white/30 focus:outline-none focus:border-[#BFF367]/50 focus:bg-white/8 transition-all px-3 w-full";
