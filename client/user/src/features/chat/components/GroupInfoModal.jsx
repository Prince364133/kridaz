...
const GroupInfoModal = ({ isOpen, onClose, chat }) => {
 ...
 <div className="w-40 h-40 rounded-full border border-white/5 bg-[#B3DC26]/10 flex items-center justify-center mb-6 overflow-hidden">
 {chat.groupImage ? (
 <img src={chat.groupImage} className="w-full h-full object-cover" alt="" />
 ) : (
 <svg className="w-20 h-20 text-[#B3DC26] opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div className="flex items-center gap-2 border-b-2 border-[#B3DC26] pb-1">
 <input
 type="text"
 value={groupName}
 ...
 <button onClick={handleRename} className="bg-[#B3DC26] text-black px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Save</button>
 </div>
 </div>
 ) : (
 ...
 {isAdmin && (
 <button onClick={() => setIsEditingName(true)} className="text-white/20 group-hover/edit:text-white/60 hover:!text-[#B3DC26] transition-colors">
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
  ...
  {chat.isCommunity && childGroups?.length > 0 && (
    <div className="bg-[#111111] py-4 px-6 mb-2 shadow-sm space-y-4">
      <h4 className="text-[13px] font-medium text-[#B3DC26]">Groups in this community</h4>
  ...
  {chat.parentCommunity && (
    <div className="bg-[#111111] py-4 px-6 mb-2 shadow-sm">
      ...
      <div className="flex items-center gap-3 bg-[#1A1A1A] p-3 rounded-[8px] border border-white/5">
        <div className="w-10 h-10 rounded-full bg-[#B3DC26]/10 flex items-center justify-center shrink-0">
 ...
 <div className="bg-[#111111] py-4 px-6 mb-2 shadow-sm space-y-4">
 <h4 className="text-[13px] font-medium text-[#B3DC26]">{chat.isCommunity ? "Add Members" : "Add Participants"}</h4>
 ...
 className="text-[#B3DC26] opacity-0 group-hover:opacity-100 p-1.5 rounded-full hover:bg-[#B3DC26]/10 transition-all"
 title="Add"
 >
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div className="flex items-center gap-3">
 {isThisAdmin && (
 <span className="border border-[#B3DC26]/40 text-[#B3DC26] text-[10px] uppercase tracking-wide px-1.5 py-0.5 rounded-sm">
                ...
                {isAdmin && !isThisAdmin && !isMe && (
                  <div className="flex items-center gap-1 opacity-0 group-hover/member:opacity-100 transition-opacity">
                    <button 
                      ...
                      className="text-[#B3DC26] hover:bg-[#B3DC26]/10 p-1.5 rounded-full transition-all"
                      title="Make Admin"
                    >
 ...
 <h4 className="text-[13px] font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#B3DC26]/80 to-[#B3DC26]/80 px-6 my-2">{chat.pendingMembers.length} pending invites</h4>
 ...
 <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#B3DC26]/60 to-[#B3DC26]/60 text-[11px] leading-tight mt-0.5">Invite sent</p>
 </div>
 </div>
 {isAdmin && (
 <button 
