...
const CreateCommunityModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const renderStep0 = () => (
    <div className="flex flex-col items-center text-center space-y-8 animate-fade-in p-8">
      ...
      <button 
        onClick={() => setStep(1)}
        className="w-full py-5 bg-[#BFF367] text-black font-black uppercase tracking-[0.2em] rounded-[8px] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
      >
  ...
  const renderStep1 = () => (
    <div className="space-y-8 animate-slide-in p-8">
      <div className="space-y-6">
        <div>
          <label className="block text-[10px] font-black text-[#BFF367] uppercase tracking-[0.3em] mb-3 ml-1">Community Details</label>
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          className="flex-1 py-5 bg-[#BFF367] text-black font-black uppercase tracking-[0.2em] rounded-[8px] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-30"
        >
