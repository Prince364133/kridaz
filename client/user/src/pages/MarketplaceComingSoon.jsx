  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#BFF367]/10 blur-[150px] rounded-full animate-pulse" />
      ...
      <div className="relative z-10 max-w-2xl w-full text-center space-y-8 animate-fade-in">
        ...
        <div className="flex justify-center mb-4">
          <div className="relative group">
            <div className="absolute -inset-4 bg-[#BFF367]/20 rounded-full blur-xl group-hover:bg-[#BFF367]/30 transition-all duration-500 animate-pulse" />
            <div className="relative w-24 h-24 bg-zinc-900 border border-[#BFF367]/30 rounded-[8px] flex items-center justify-center shadow-2xl">
              <ShoppingBag size={42} className="text-[#BFF367]" />
            </div>
          </div>
        </div>

        {/* Status Badge */}
        <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-zinc-900/50 border border-zinc-800 rounded-[6px] text-[10px] font-black uppercase tracking-[0.2em] text-[#BFF367]">
          <span className="w-1.5 h-1.5 rounded-full bg-[#BFF367] animate-ping" />
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl md:text-2xl font-bold text-[#BFF367] uppercase tracking-wide">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-4">
          {[
            ...
            <div key={i} className="p-4 bg-zinc-900/30 border border-zinc-800 rounded-[8px] flex flex-col items-center gap-2">
              <item.icon size={20} className="text-[#BFF367]" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
          <Link 
            to="/" 
            className="w-full sm:w-auto bg-[#BFF367] text-black px-10 py-4 rounded-[8px] font-black uppercase text-xs tracking-widest hover:scale-105 transition-all shadow-[0_20px_40px_rgba(85,222,232,0.2)]"
          >
            Back to Arena
          </Link>
          <button 
      ...
      <div className="fixed bottom-10 left-10 hidden xl:block animate-bounce-slow">
        <div className="flex flex-col items-start">
          <div className="w-1 h-20 bg-gradient-to-t from-[#BFF367] to-transparent opacity-20 mb-4" />
