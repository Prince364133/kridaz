...
import {
  ...
  ArrowRight, ShieldCheck, Trophy, Star
} from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto px-6 pt-36 pb-12">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
            ...
            <div className="flex items-center gap-6">
              <div
                className="w-20 h-20 rounded-2xl flex items-center justify-center border shrink-0"
                style={{ borderColor: BDR, backgroundColor: "#111" }}
              >
