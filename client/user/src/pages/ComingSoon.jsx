...
const ComingSoon = () => {
  ...
  const roleConfig = {
    ...
    umpire: {
      label: "Official",
      accent: "#BFF367",
      accentLight: "text-transparent bg-clip-text bg-gradient-to-r from-[#BFF367] to-[#BFF367]",
      accentBg: "bg-gradient-to-r from-[#BFF367]/10 to-[#BFF367]/10",
      accentBorder: "border-[#BFF367]/20",
