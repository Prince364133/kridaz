      ...
      <div className="p-4 md:p-10 space-y-6 md:space-y-12 animate-fade-in pt-2 pb-24 md:pb-12 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="flex items-center gap-2 text-[10px] font-black text-primary uppercase tracking-widest">
                  Open Engine <CheckCircle2 size={12} />
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="p-8 md:p-10 bg-[#0A0A0A] rounded-[2.5rem] border border-white/5 flex flex-col transition-all hover:border-[#84CC16]/20 group">
            ...
            <button 
              onClick={() => navigate("/scorer/matches")}
              className="mt-10 w-full h-14 border border-white/10 hover:border-[#84CC16]/50 hover:bg-[#84CC16]/5 rounded-2xl font-black uppercase text-xs tracking-[0.2em] transition-all text-gray-400 hover:text-white"
            >
              View Full Schedule
            </button>
          </div>
