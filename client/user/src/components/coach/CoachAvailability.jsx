    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-[#84CC16]/5 border border-[#84CC16]/10 rounded-[32px] p-8">
            <div className="flex items-center gap-3 mb-4">
              <Zap className="text-primary" size={20} />
              <h4 className="text-sm font-black uppercase tracking-widest text-white">Quick Tips</h4>
            </div>
            <ul className="space-y-3 text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-relaxed">
