              ...
              <div className="p-8">
                <div className="flex flex-col md:flex-row justify-between gap-8">
                  ...
                  <div className="flex flex-col md:items-end gap-2">
                    ...
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Reserved in wallet</p>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4 md:col-span-2">
                    ...
                    <div className="p-4 bg-white/5 border border-white/10 rounded-2xl text-xs text-gray-400 italic">
                ...
                {booking.status === 'PENDING' && (
                  <div className="mt-8 flex gap-4">
                    ...
                    <button 
                      ...
                      disabled={actionLoading === booking._id}
                      className="flex-1 h-14 bg-white/5 text-white border border-white/10 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-red-500/10 hover:text-red-500 hover:border-red-500/20 transition-all flex items-center justify-center gap-2"
                    >
