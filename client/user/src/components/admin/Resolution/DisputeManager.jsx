...
const DisputeManager = () => {
 ...
 <div className="p-12 text-center text-gray-500 font-medium ">No disputes found matching criteria</div>
 ) : (
 ...
 <p className="text-gray-400 text-sm leading-relaxed max-w-2xl border-l-2 border-orange-500/30 pl-4">
 ...
 <p className="text-[9px] text-gray-600 mt-2 font-bold uppercase ">* Remaining ₹{selectedDispute.bookingDetails?.ownerRevenue - (parseFloat(partialAmount) || 0)} will be released to owner.</p>
 </div>
 )}
