...
const FinancialMissionControl = () => {
 ...
 <td className="px-6 py-4">
 <p className="font-black text-white text-[16px] tracking-tighter ">
 ...
 <div className="text-[10px] text-[#878C9F] font-mono uppercase tracking-tighter">
 ...
 <div className="mb-8">
 <h3 className="text-xl font-black uppercase tracking-tighter mb-1">Pending <span className="text-[#CCFF00]">KYC Verifications</span></h3>
 ...
 <div>
 <h3 className="text-xl font-black uppercase tracking-tighter ">Settlement <span className="text-[#CCFF00]">Logistics</span></h3>
 ...
 <p className="text-[10px] text-[#878C9F] font-medium uppercase tracking-wider">Automated batch processing occurs at 00:00 GMT on selected day.</p>
 </div>
 ...
 <p className="font-mono text-[#CCFF00] text-xl font-black ">Rs 5,000</p>
 </div>
