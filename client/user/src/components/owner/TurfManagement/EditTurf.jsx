          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#55DEE8] font-bold text-sm">₹</span>
                <input
                        ...
                        >
                          ...
                          {slot.isActive && (
                            <div className="space-y-3 pt-2 border-t border-[#1A1A1A]">
                              <div className="relative">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#55DEE8] font-bold text-[10px]">₹</span>
                                <input
                                  type="number"
                                  value={slot.price}
