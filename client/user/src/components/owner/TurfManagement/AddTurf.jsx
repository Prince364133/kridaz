...
const AddTurf = () => {
 ...
 <p className="text-[10px] text-[#444] mb-4 uppercase tracking-widest ml-1">
 ...
 <p className="text-[10px] text-[#444] mt-3 uppercase tracking-widest ml-1">Select multiple files at once. Max 10 images allowed.</p>
 </div>
 ...
 <p className="text-[#333] text-[10px] font-bold uppercase tracking-[4px] text-center py-6 border border-dashed border-[#2D2D2D] rounded-[8px] ">
 ...
 <p className="text-[9px] text-[#444] uppercase tracking-widest ml-1 leading-relaxed">
 * After the selected duration, slots will be marked as "Needs Update" and booking will be blocked until pricing/timing is reviewed.
 ...
 <p className="text-[9px] text-[#878C9F] font-bold uppercase tracking-widest ">Set individual slot pricing below</p>
 ...
 * After 5% service charge (Includes payment gateway charges and GST)
 ...
 <span className="text-[13px] font-black text-[#CCFF00] font-mono tracking-tight ">
 ...
 <p className="text-[10px] text-[#444] uppercase tracking-widest text-center">Click a slot to toggle its operational availability.</p>
 </div>
 </div>
 </div>
