...
export default function CustomerDirectory() {
  ...
  if (loading) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-[#000] text-[#55DEE8] gap-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10 border-b border-[#2D2D2D] pb-6">
          <div>
            <div className="flex items-center gap-3">
              <User className="text-[#55DEE8]" size={32} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
          ...
          <div className="bg-[#000000] border border-[#2D2D2D] rounded-[8px] p-5 flex flex-col relative overflow-hidden shadow-[var(--shadow-2)] hover:border-[#55DEE8]/30 transition-all duration-500">
            ...
            <div className="flex items-end justify-between">
              ...
              <span className="px-2 py-0.5 bg-[#55DEE8]/10 text-[#55DEE8] text-[10px] font-medium uppercase tracking-wider rounded-full">Returning</span>
            </div>
          </div>
        </div>
          ...
          <div className="p-4 border-b border-[#2D2D2D] flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="relative flex-1 max-w-xl">
              ...
              <input
                ...
                className="w-full bg-[#2D2D2D] border border-[#404040] text-white pl-10 pr-4 py-2 rounded-[6px] text-[14px] focus:outline-none focus:border-[#55DEE8] transition-colors font-inter"
              />
            </div>
                  ...
                  filteredCustomers.map((customer) => (
                    <tr key={customer.id} className="group hover:bg-[#2D2D2D]/20 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className={`w-8 h-8 rounded-[4px] flex items-center justify-center shrink-0 ${customer.isRegistered ? 'bg-[#55DEE8]/20' : 'bg-[#2D2D2D]'}`}>
