      ...
      <Link
        ...
        className={`flex items-center h-[48px] px-4 group relative transition-all duration-300 rounded-[8px] mx-2 mb-1 border border-transparent ${
          isActive 
            ...
            : "bg-transparent text-[#999999] hover:bg-white/10/5 hover:text-white/70 hover:border-white/30/10"
        ...
        <div className="flex-shrink-0 flex items-center justify-center w-6">
          <Icon 
            ...
            className={`transition-colors duration-300 ${
              isActive ? "text-black" : "text-[#999999] group-hover:text-white/70"
    ...
    >
      <div className="flex flex-col p-4 border-b border-[#2D2D2D] bg-[#000000] gap-4 lg:hidden">
        <div className="flex items-center justify-end">
          <button onClick={toggleSidebar} className="text-[#999999] hover:text-white/70 transition-colors">
            <X size={20} />
          </button>
        </div>
      </div>
