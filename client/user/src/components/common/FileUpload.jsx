...
const FileUpload = ({ label, onUploadSuccess, folder = "kridaz/verification", accept = "image/*,.pdf" }) => {
  ...
  return (
    <div className="space-y-3 group/field">
      <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-[#84CC16] transition-colors ml-1">
        {label}
      </label>
              ...
              <div className="mt-2 flex items-center gap-2">
                {uploading ? (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[8px] font-bold text-[#84CC16] uppercase tracking-widest animate-pulse">Uploading...</span>
                  </div>
                ) : uploadedUrl ? (
