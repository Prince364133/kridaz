...
const GroundCard = ({ ground }: { ground: typeof groundsData[0] }) => (
  <Link to={`/venues/${ground.id}`} className="block group h-full">
                ...
                {activeTab === 'grounds' ? (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="flex justify-center">
                            <GradientButton onClick={() => navigate(ROUTES.PUBLIC.VENUES)} variant="outline" className="min-w-[200px] border-white/20 text-white hover:border-[#A1FF00] hover:text-[#A1FF00]">
                                View All Venues
                            </GradientButton>
                        </div>
                    </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                             {categories.map((cat) => (
                                <Link to="/marketplace" key={cat.id} className="group relative overflow-hidden rounded-3xl border border-white/10 transition-all hover:border-[#A1FF00]/50 hover:shadow-[0_0_30px_rgba(161,255,0,0.15)]">
