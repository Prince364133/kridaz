...
const HostGame = () => {
 ...
 <p className="text-neutral-500 text-sm font-medium">No {gameData.gameType} grounds found in {gameData.city}, {gameData.state}.</p>
 </div>
 )}
 </div>
 </section>
 ...
 <div className="p-12 border-2 border-dashed border-neutral-800 rounded-3xl text-center bg-neutral-900/30">
 <p className="text-neutral-500 text-sm font-medium">No {gameData.gameType} experts available in {gameData.city}, {gameData.state}.</p>
 </div>
 )}
 </div>
 </section>
 ...
 <p className="text-neutral-500 font-medium ">Assign players to slots or leave them open for the community</p>
 </div>
 ...
 <p className="text-[11px] text-neutral-500 font-medium ">Recommended: Total Cost ({totalCost}) / Total Players</p>
 </div>
 ...
 <p className="text-xs text-neutral-500 mt-1 font-medium ">{selectedGround?.location}</p>
 </div>
 </div>
 <div className="bg-black/20 border border-white/5 p-6 rounded-3xl flex items-center gap-5">
 <div className="w-16 h-16 bg-neutral-800 rounded-2xl flex items-center justify-center">
 ...
 <p className="text-xs text-neutral-500 mt-1 font-medium ">{selectedUmpire?.role || 'Professional'}</p>
 </div>
 </div>
 </div>
 ...
 <div className="px-6 py-2 bg-neutral-800 rounded-2xl border border-neutral-700 text-[10px] font-black text-neutral-400 uppercase tracking-[0.3em] ">VS</div>
 <div className="flex -space-x-3">
