...
const MyJoinedGames = () => {
 ...
 <h1 className="text-3xl font-black tracking-tighter uppercase">MY JOINED MATCHES</h1>
 ...
 <span className="bg-red-500 text-white px-6 py-2 rounded-full font-black uppercase tracking-tighter transform -rotate-12">
 GAME CANCELLED
 </span>
 </div>
 )}
 ...
 <h2 className="text-2xl font-black mt-1 uppercase tracking-tighter">
 {game.gameMode === 'QUICK' 
