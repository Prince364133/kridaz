...
const ACCENT = "#F59E0B"; // Amber for umpires/officials

const UmpireSignUp = () => {
  const { register, handleSubmit, errors, onSubmit, loading } = usePartnerSignUpForm("umpire");
        ...
        <div className="hidden lg:flex lg:col-span-2 flex-col space-y-12">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-500/20 bg-amber-500/5">
              ...
              <span className="text-[10px] font-bold tracking-[0.2em] text-amber-400 uppercase">Official Network</span>
            </div>
          ...
          <div className="space-y-4">
            {[
              { icon: Clock, label: "Smart Scheduling", val: "Coming Soon" },
              { icon: Award, label: "Verified Credentials", val: "Coming Soon" },
              { icon: CheckCircle, label: "Match Assignments", val: "Coming Soon" },
              { icon: ShieldCheck, label: "Official Rating", val: "Coming Soon" },
            ].map((item, i) => (
          ...
          <div className="w-full bg-[#0A0A0A] border border-white/10 rounded-[40px] overflow-hidden relative">
            ...
            <div className="bg-white/[0.02] border-b border-white/5 p-8 md:p-10 flex justify-between items-center">
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-bold text-white uppercase tracking-wider">Join as an Official</h2>
                <p className="text-xs text-white/20 uppercase tracking-widest">Secure your spot on the waitlist</p>
              </div>
              <Scale size={32} className="text-amber-400/30" />
            </div>
            ...
            <div className="p-8 md:p-14 space-y-10">
              <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/20 flex items-start gap-3">
                ...
                <p className="text-xs text-amber-300/70 leading-relaxed">
                  The Officials module is <strong className="text-amber-300">coming soon</strong>. Register now to secure your spot on the early access waitlist and be part of the official rollout.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                >
                  {loading ? "Securing Your Spot..." : "Join Official Waitlist"}
