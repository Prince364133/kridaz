...
const CoachSignUp = () => {
  const { register, handleSubmit, errors, onSubmit, loading } = usePartnerSignUpForm("coach");
            ...
            <div className="p-8 md:p-14 space-y-10">
              <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/20 flex items-start gap-3">
                ...
                <p className="text-xs text-blue-300/70 leading-relaxed">
                  The Coach module is <strong className="text-blue-300">coming soon</strong>. Register now to secure your spot on the early access waitlist and be among the first coaches on the platform.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                  <div className="space-y-3 group/field">
                    <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-blue-400 transition-colors ml-1">Full Name <span className="text-red-500">*</span></label>
                  ...
                  <div className="space-y-3 group/field">
                    <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-blue-400 transition-colors ml-1">Email Address <span className="text-red-500">*</span></label>
                    <div className="relative">
                  ...
                  <div className="space-y-3 group/field">
                    <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-blue-400 transition-colors ml-1">Phone Number <span className="text-red-500">*</span></label>
                    <div className="relative">
                  ...
                  <div className="space-y-3 group/field">
                    <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-blue-400 transition-colors ml-1">Password <span className="text-red-500">*</span></label>
                    <div className="relative">
                  ...
                  <div className="space-y-3 md:col-span-2 group/field">
                    <label className="text-xs font-bold text-white/20 uppercase tracking-widest group-focus-within/field:text-blue-400 transition-colors ml-1">Confirm Password <span className="text-red-500">*</span></label>
                    <div className="relative">
                ...
                >
                  {loading ? "Securing Your Spot..." : "Join Coach Waitlist"}
