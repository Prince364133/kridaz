  ...
  return (
    <div className="min-h-screen bg-[#000] relative overflow-hidden flex flex-col items-center justify-start pt-4 lg:pt-10 pb-20 font-sans">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-black via-black/95 to-[#55DEE8]/5" />
        <div className="absolute top-1/3 right-0 w-[600px] h-[600px] bg-[#55DEE8]/5 blur-[150px] rounded-full pointer-events-none" />
      </div>
        ...
        <div className="hidden lg:flex lg:col-span-2 flex-col space-y-12">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#55DEE8]/20 bg-[#55DEE8]/5">
              <Building2 size={12} className="text-[#55DEE8]" />
              <span className="text-[10px] font-bold tracking-[0.2em] text-[#55DEE8] uppercase">Venue Partner Program</span>
            </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                <div className="flex items-center gap-4">
                  <item.icon size={16} className="text-[#55DEE8]/50" />
                  <span className="text-xs font-bold text-white/40 uppercase tracking-widest">{item.label}</span>
                </div>
                <span className="text-xs font-bold text-[#55DEE8] uppercase">{item.val}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="bg-white/[0.02] border-b border-white/5 p-8 md:p-10 flex justify-between items-center">
              <div className="space-y-1">
                <div className="inline-flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] font-bold tracking-[0.2em] text-[#55DEE8]/60 uppercase">Venue Owner</span>
                </div>
            ...
            <div className="p-8 md:p-14 space-y-10">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#55DEE8] hover:bg-[#a3e635] text-black h-16 rounded-xl font-bold uppercase tracking-wider text-xl flex items-center justify-center gap-3 active:scale-[0.98] transition-all disabled:opacity-50 group/btn"
                >
              ...
              <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <Link to="/login" className="flex items-center gap-2 text-[#55DEE8] hover:text-white transition-colors text-xs font-bold uppercase tracking-widest group">
