...
const JoinGames = () => {
 ...
 <button onClick={() => setSelectedGame(null)} className="w-10 h-10 bg-[#121212] border border-[#2D2D2D] rounded-full flex items-center justify-center text-[#55DEE8] hover:bg-[#55DEE8] hover:text-black transition-all">✕</button>
 </div>
