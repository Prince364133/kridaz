...
const JoinGames = () => {
 ...
 <div className="absolute -left-6 top-1/2 -translate-y-1/2 w-1.5 h-16 rounded-full shadow-[0_0_25px_rgba(204,255,0,0.5)] hidden md:block" style={{ background: 'linear-gradient(180deg, #55DEE8 0%, #BFF367 100%)' }}></div>
 ...
 className="px-6 py-3.5 bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black font-black text-[11px] uppercase tracking-widest rounded-[12px] flex items-center gap-2.5 hover:scale-105 transition-all duration-500 shadow-[0_0_30px_rgba(204,255,0,0.2)]"
 >
 ...
 <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#BFF367] transition-colors" size={20} />
 <input 
 className="w-full bg-[#0d0d0d] border border-white/10 rounded-[12px] py-4 pl-12 pr-4 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-white/30/50 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]" 
 ...
 className="px-6 bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black font-black text-[11px] uppercase tracking-widest rounded-[12px] hover:scale-105 transition-all shadow-[0_0_20px_rgba(204,255,0,0.2)]"
 >
 Search
 </button>
 ...
 <Filter className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#BFF367] transition-colors" size={18} />
 <select 
 className="w-full bg-[#0d0d0d] border border-white/10 rounded-[12px] py-4 pl-12 pr-4 appearance-none text-sm text-white focus:outline-none focus:border-white/30/50 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]"
 value={sportFilter}
 onChange={(e) => {
 ...
 <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-[#BFF367] transition-colors pointer-events-none" size={16} />
 <select
 className="w-full bg-[#0d0d0d] border border-white/10 rounded-[12px] py-4 pl-10 pr-4 appearance-none text-sm text-white focus:outline-none focus:border-white/30/50 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] disabled:opacity-40"
 value={selectedState}
 ...
 <div className="md:col-span-2 relative group">
 <select
 className="w-full bg-[#0d0d0d] border border-white/10 rounded-[12px] py-4 px-4 appearance-none text-sm text-white focus:outline-none focus:border-white/30/50 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] disabled:opacity-40"
 value={selectedCity}
 ...
 className="w-full flex items-center justify-center gap-1.5 py-4 bg-[#BFF367]/10 border border-[#BFF367]/20 hover:bg-red-500/10 hover:border-red-500/30 text-[#BFF367] hover:text-red-400 rounded-[12px] text-[10px] font-black uppercase tracking-widest transition-all"
 title="Clear location filter"
 >
 <X size={14} />
 </button>
 ) : (
 <div className="w-full flex items-center justify-center gap-1 py-4 bg-[#BFF367]/5 border border-[#BFF367]/10 rounded-[12px]">
 <MapPin size={14} className="text-[#BFF367]" />
 <span className="text-[9px] font-black text-[#BFF367]/50 uppercase tracking-widest truncate">
 ...
 className="px-10 py-4 bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black font-black text-xs uppercase tracking-[0.2em] rounded-full shadow-[0_0_20px_rgba(204,255,0,0.2)] hover:scale-105 transition-all"
 >
 Create Match
 </button>
 </div>
 ...
 className="group relative rounded-[32px] overflow-hidden cursor-pointer bg-[#0A0A0A] border border-white/5 hover:border-white/30/30 transition-all duration-500"
 ...
 <div className="px-4 py-1.5 bg-[#BFF367]/20 border border-[#BFF367]/40 rounded-full backdrop-blur-sm inline-flex">
 <span className="text-[10px] font-black text-[#BFF367] uppercase tracking-widest">{game.gameType}</span>
 </div>
 {game.gameMode === 'QUICK' && (
 ...
 <Coins size={13} className="text-[#BFF367]" />
 ...
 <div className="h-px flex-1 bg-[#BFF367]/30" />
 <div className="flex items-center gap-2">
 <span className="text-[9px] font-black text-[#BFF367]/70 uppercase tracking-[0.4em] flex items-center gap-1">
 <Zap size={10} className="text-[#BFF367]" /> {game.gameMode === 'QUICK' ? 'Casual Pool' : 'Rivalry Ledger'}
 </span>
 {game.isLive && (
 ...
 {game.gameMode === 'QUICK' ? (
 <>Casual <span style={{ background: 'linear-gradient(90deg, #55DEE8 0%, #BFF367 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>{game.gameType}</span> Match</>
 ) : (
 <div className="flex items-baseline gap-2 flex-wrap">
 <span>{game.teams?.teamA?.name}</span>
 <span className="text-[#BFF367] text-sm">VS</span>
 ...
 <div className="bg-black/50 border border-[#BFF367]/20 rounded-[12px] p-3 flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-lg bg-[#BFF367]/10 border border-[#BFF367]/20 flex items-center justify-center">
 <Calendar size={14} className="text-[#BFF367]" />
 </div>
 <div>
 <p className="text-[7px] font-black text-[#BFF367]/60 uppercase tracking-widest mb-0.5">Start Date & Time</p>
 <p className="text-[13px] font-black text-white">
 {new Date(game.date).toLocaleDateString('en-GB', { day: '2-digit', month: 'short' })} • {game.time}
 </p>
 </div>
 </div>
 <Clock size={14} className="text-[#BFF367]/40" />
 </div>

 {/* Slots */}
 <div className="flex items-center justify-between pt-1 border-t border-white/5">
 <div className="flex items-center gap-2.5">
 <div className="w-8 h-8 rounded-full bg-[#BFF367]/10 border border-[#BFF367]/20 flex items-center justify-center">
 ...
 <p className="text-[7px] font-bold text-[#BFF367]/50 uppercase tracking-widest mt-0.5">Available Capacity</p>
 </div>
 </div>
 <div className="flex -space-x-1.5">
 {[...Array(4)].map((_, i) => (
 <div key={i} className="w-6 h-6 rounded-full border border-[#0d0d0d] bg-[#BFF367]/10 flex items-center justify-center shadow-lg">
 <Users size={10} className="text-[#BFF367]/50" />
 </div>
 ))}
 </div>
 </div>
 ...
 <MapPin size={10} className="text-[#BFF367] shrink-0" />
 ...
 className="text-[8px] font-black text-white/30 hover:text-white/70 uppercase tracking-widest transition-colors flex items-center gap-1"
 >
 ...
 <div className="flex items-center justify-between gap-3 pt-1 border-t border-white/5">
 <div className="flex items-center gap-2.5">
 <div className="w-9 h-9 rounded-full border border-[#BFF367]/20 bg-[#1A1A1A] flex items-center justify-center overflow-hidden shrink-0">
 {game.host?.profilePicture ? (
 <img src={game.host.profilePicture} alt="" className="w-full h-full object-cover" />
 ) : (
 <span className="text-[#BFF367] font-black text-[11px]">
 ...
 : 'bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black shadow-[0_0_20px_rgba(204,255,0,0.4)] hover:shadow-[0_0_30px_rgba(204,255,0,0.6)]'
 }`}>
 ...
 <div className="px-4 py-1.5 bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black text-[10px] font-black uppercase tracking-[0.2em] rounded-full">
 ...
 className="px-3 py-1.5 bg-white/5 border border-white/10 hover:border-white/30/40 rounded-full flex items-center gap-1.5 transition-all"
 ...
 <button onClick={() => setSelectedGame(null)} className="w-10 h-10 bg-[#121212] border border-[#2D2D2D] rounded-full flex items-center justify-center text-[#BFF367] hover:bg-white/10 hover:text-black transition-all">✕</button>
 </div>
 ...
 <div key={i} className="bg-[#0d0d0d] border border-[#2D2D2D] p-5 rounded-[20px] text-center group hover:border-white/30/40 transition-all">
 <stat.icon className="mx-auto mb-3 text-[#BFF367]" size={24} />
 ...
 <span className="text-[10px] font-black text-[#BFF367] uppercase tracking-widest">{selectedGame.quickSlots.length} Total Slots</span>
 </div>
 ...
 slot.status === 'OPEN' 
 ? 'bg-[#121212] border-white/5 hover:border-white/30/40 hover:bg-white/10/5' 
 : 'bg-black/50 opacity-40 border-transparent'
 }`}
 >
 {slot.status === 'OPEN' && (
 <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#55DEE8] to-[#BFF367] scale-y-0 group-hover:scale-y-100 transition-transform" />
 )}
 ...
 <span className="text-[10px] font-black text-[#BFF367] uppercase tracking-widest">Team {tIdx === 0 ? 'A' : 'B'}</span>
 </div>
 ...
 >
 <div className="w-20 h-20 bg-[#BFF367]/10 border border-[#BFF367]/20 rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_30px_rgba(204,255,0,0.1)]">
 ...
 className="flex-1 py-4 bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black font-black rounded-xl text-[11px] uppercase tracking-widest shadow-[0_0_20px_rgba(204,255,0,0.2)] hover:scale-105 transition-all"
 >
 Confirm
 </button>
 </div>
 ...
 animate={{ scale: 1, opacity: 1, y: 0 }}
 exit={{ scale: 0.9, opacity: 0, y: 20 }}
 className="relative bg-[#000000] border border-[#BFF367]/20 p-8 rounded-[32px] max-w-md w-full shadow-[0_0_50px_rgba(204,255,0,0.1)]"
 >
