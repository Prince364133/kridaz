      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 px-6 py-4 bg-zinc-900/50 border border-zinc-800 rounded-3xl">
            <ShieldCheck className="w-5 h-5 text-[#BFF367]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="relative group overflow-hidden bg-gradient-to-br from-[#55DEE8] to-[#4D7C0F] p-8 rounded-[2.5rem] shadow-2xl shadow-[#BFF367]/20 animate-slide-in-left">
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-5 pl-14 pr-6 text-xl font-bold focus:border-white/30 focus:ring-1 focus:ring-white/20 transition-all outline-none"
                  />
                </div>
                <div className="grid grid-cols-3 gap-2">
                  {[500, 1000, 2000].map((amt) => (
                    <button
                      ...
                      className="py-3 rounded-xl border border-zinc-800 hover:border-white/30 hover:text-white/70 font-bold text-xs uppercase transition-all"
                    >
                      +{amt}
                    </button>
                  ))}
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#55DEE8] to-[#BFF367] text-black h-16 rounded-2xl font-black uppercase tracking-wider flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:grayscale"
                >
                  {isProcessing ? (
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex flex-col items-end gap-1">
                          <span className={`text-[8px] font-black uppercase px-2 py-0.5 rounded-full ${
                            tx.status === "SUCCESS" ? "bg-[#55DEE8]/10 text-[#BFF367]" : 
