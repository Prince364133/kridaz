        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-zinc-500 font-bold uppercase text-[10px] tracking-widest italic">Review your professional reservation</p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[10px] font-bold text-zinc-500 mt-0.5 uppercase tracking-widest italic">Google Pay, PhonePe, Paytm</p>
                      </div>
                    </div>
