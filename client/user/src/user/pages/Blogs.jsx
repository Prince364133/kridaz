...
const Blogs = () => {
 ...
 <span className="text-white/20 ">Stories & Insights</span>
 </h1>
 ...
 <p className="text-white/20 font-display text-4xl uppercase ">No articles found</p>
 <button 
 ...
 <h3 className="font-display text-3xl md:text-4xl text-white leading-[0.9] uppercase mb-6 group-hover:text-primary transition-colors">
 {blog.title}
 </h3>
