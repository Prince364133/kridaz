...
const TurfDetails = () => {
 ...
 <span className="text-3xl font-bold text-[#55DEE8]">₹{turf.pricePerHour}</span>
 ...
 <span className={`text-[9px] font-bold ${isSelected ? "text-black/70" : "text-[#55DEE8]"}`}>₹{price}</span>
 </button>
 );
 })
 ) : (
 ...
 <span className="text-xl font-black text-[#55DEE8]">₹{totalPrice}</span>
 </div>
 </div>
 )}
 <button 
