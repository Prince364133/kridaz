...
const WICKET_TYPES = [
 ...
 { key: 'OBSTRUCTING', label: 'Obstructing Field', needsFielder: false },
 { key: 'RETIRED_HURT',label: 'Retired Hurt', needsFielder: false },
 { key: 'RETIRED_OUT', label: 'Retired Out', needsFielder: false },
...
const WicketModal = ({
 ...
 const [step, setStep] = useState('type'); // 'type' | 'fielder' | 'nextBatter'
 ...
 onConfirm({ wicketType, fielderId, nextBatterId: nextId, runs: 0 });
 };
 ...
 <button
 onClick={() => onConfirm({ wicketType, fielderId, nextBatterId: null, runs: 0 })}
 ...
 <button
 onClick={() => setStep(step === 'nextBatter' && selectedMeta?.needsFielder ? 'fielder' : 'type')}
