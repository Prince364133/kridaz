const TurfDetailsSkeleton = () => (
 ...
 <div className="skeleton h-16 md:h-20 w-full bg-zinc-800 rounded-2xl"></div>
 ...
 <div className="md:col-span-8 skeleton bg-zinc-800 rounded-[2rem]"></div>
 <div className="md:col-span-4 skeleton bg-zinc-800 rounded-[2rem]"></div>
 </div>
 </div>
 ...
 <div className="skeleton h-32 w-full bg-zinc-800 rounded-2xl"></div>
 </div>
 <div className="space-y-8">
 <div className="skeleton h-8 w-64 bg-zinc-800 rounded-full"></div>
 <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
 {[...Array(6)].map((_, i) => (
 <div key={i} className="skeleton h-16 w-full bg-zinc-800 rounded-2xl"></div>
 ))}
 </div>
 </div>
 </div>
 <div className="lg:col-span-4">
 <div className="skeleton h-[500px] w-full bg-zinc-800 rounded-[2.5rem]"></div>
 </div>
 </div>
 </div>
 </div>
