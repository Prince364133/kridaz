...
export default function VenueCheckoutPage() {
  ...
  const handleCompletePayment = async () => {
    ...
    try {
      ...
      // 2. Razorpay Options
      const options = {
        key: process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID || 'rzp_test_KEY_HERE', // Fallback for dev if env missing
                ...
                {isPaymentSuccessful ? (
                    <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-lg p-6 text-center space-y-4">
                        ...
                        <Button asChild className="w-full" size="lg">
                            <Link href={`/booking/${bookingDetails.id}`}>View Booking Ticket</Link>
                        </Button>
                    </div>
                ) : isBookingCancelled ? (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start space-x-2 py-2">
                            ...
                            <div className="grid gap-1 leading-none">
                                ...
                                >
                                    I agree to the <Link href="/terms" className="text-primary underline">Terms of Service</Link> and <Link href="/refund-policy" className="text-primary underline">Cancellation Policy</Link>
                                </label>
                            </div>
                        </div>
