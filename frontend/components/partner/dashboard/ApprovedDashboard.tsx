...
export function ApprovedDashboard({ router: _router }: ApprovedDashboardProps) {
  const venueOwnerWebUrl = process.env.NEXT_PUBLIC_VENUE_OWNER_WEB_URL || 'http://localhost:3001';
      ...
      <motion.div variants={fadeInUp}>
        <Card className="shadow-2xl border-0 bg-gradient-to-br from-primary via-primary/95 to-primary/90 text-primary-foreground overflow-hidden relative group">
          ...
          <CardContent className="p-8 relative z-10">
            ...
            <Link href={venueOwnerWebUrl} target="_blank">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href={`${venueOwnerWebUrl}/venues`} target="_blank" className="w-full">
              ...
              <Link href={`${venueOwnerWebUrl}/bookings`} target="_blank" className="w-full">
                <Button variant="outline" className="w-full h-auto py-4 flex-col gap-2 hover:border-primary hover:text-primary transition-colors">
                  <Calendar className="h-5 w-5" />
                  View Bookings
                </Button>
              </Link>
              <Link href={`${venueOwnerWebUrl}/settings/billing`} target="_blank" className="w-full">
                <Button variant="outline" className="w-full h-auto py-4 flex-col gap-2 hover:border-primary hover:text-primary transition-colors">
                  <IndianRupee className="h-5 w-5" />
                  Payout Settings
                </Button>
              </Link>
              <Link href={`${venueOwnerWebUrl}/analytics`} target="_blank" className="w-full">
                <Button variant="outline" className="w-full h-auto py-4 flex-col gap-2 hover:border-primary hover:text-primary transition-colors">
