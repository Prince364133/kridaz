          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <Link href="#" className="text-xs text-white/60 hover:text-[#A1FF00] transition-colors leading-relaxed">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.label}>
                  <Link href={item.href} className="text-xs text-white/60 hover:text-[#A1FF00] transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <Link href="mailto:contact@bmsapp.in" className="text-xs text-white/60 hover:text-[#A1FF00] transition-colors">
                    contact@bmsapp.in
                  </Link>
                </div>
              </li>
              <li className="flex items-start gap-2">
                ...
                <Link href="#" className="text-xs text-white/60 hover:text-[#A1FF00] transition-colors">
